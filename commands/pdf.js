...
async function pdfCommand(sock, chatId, text, message) {
  ...
  try {
    ...
    const footerText = "PDF GENERATED BY SAMKIELBOT";
    doc.fontSize(10).text(footerText, 0, doc.page.height - 70, {
      align: "center",
      width: doc.page.width,
    });

    // Add clickable link
    doc.fontSize(10).fillColor("blue").text("www.samkielbot.app", {
      align: "center",
